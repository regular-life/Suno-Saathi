...
class TestSunoSaarthiAPI(unittest.TestCase):
    ...
    def test_navigation_query(self):
        ...
        payload = {"query": "Is there a flyover ahead?", "current_location": "Delhi"}
    ...
    def test_llm_generate(self):
        ...
        payload = {"prompt": "How's the traffic?", "max_tokens": 50, "temperature": 0.7}
    ...
    def test_wake_word_detection(self):
        ...
        payload = {"text": "suno saarthi, how far is the destination?"}
